"use client";
import { Listing, Reservation, User } from "@/app/generated/prisma/client";
            ...
            <div className="max-w-screen-lg mx-auto">
                <div className="flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-7 md:gap-10 mt-6">
                        <ListingInfo user={listing.user} listing={listing} category={category} description={listing.description || ""} roomCount={listing.roomCount} guestCount={listing.guestCount} bathroomCount={listing.bathroomCount} locationValue={listing.locationValue || ""} />
